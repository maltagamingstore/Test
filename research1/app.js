(() => {
  ...
  const names={immediate_exit_v1:'Immediate exit',fixed_1h_example:'Hold 1 hour',fixed_2h_example:'Hold 2 hours',recovery_or_2h_example:'Recovery / 2h deadline'};
